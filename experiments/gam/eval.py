...
def main():
    ...
    for dataset_name, datasets in rankeval_datasets.items():
        dataset_model_path = Path(base_folder / f"{dataset_name}" / f"{dataset_name}.pickle")
